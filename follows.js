(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'jhkdVqZgfnPT0qZpx_fkjshIoaKSAKxnckRGNUJjTG9ZOD0g', // Unique master Xively API key to be used as a default
		defaultFeeds	= [72161,78658,1526458792], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'My Sensors', // Replaces Xively logo in the header
							...
							xively.datastream.history(feedId, datastream.id, {duration: duration, interval: interval, limit: 1000}, function(datastreamData) {
								...
								if(datastreamData.datapoints) {
									...
									var graph = new Rickshaw.Graph( {
										...
										min: minv - (maxv - minv)*0.1,
										max: maxv + (maxv - minv)*0.1,
										padding: {
											top: 0.02,
											right: 0.02,
											bottom: 0.02,
